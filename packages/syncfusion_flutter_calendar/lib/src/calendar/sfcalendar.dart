...
class SfCalendar extends StatefulWidget {
  ...
  ///        color: Colors.grey.withOpacity(alpha:0.2),
  ///        text: 'Break'));
  ///
  ///    return regions;
  ///  }
...
class _SfCalendarState extends State<SfCalendar>
  ...
  Widget? _getItem(BuildContext context, int index, bool isRTL) {
    ...
    dividerColor = dividerColor.withOpacity(dividerColor.alpha * 0.5);
...
class _CalendarHeaderViewState extends State<_CalendarHeaderView> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color arrowColor =
        headerTextColor.withOpacity(headerTextColor.alpha * 0.6);
    ...
    if (!DateTimeHelper.canMoveToNextView(
      ...
      nextArrowColor = nextArrowColor.withOpacity(nextArrowColor.alpha * 0.5);
    }
    ...
    if (!DateTimeHelper.canMoveToPreviousView(
        ...
        dates,
        widget.nonWorkingDays)) {
      prevArrowColor = prevArrowColor.withOpacity(prevArrowColor.alpha * 0.5);
    }
