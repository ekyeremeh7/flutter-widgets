...
class ColorConditionValue extends ConditionValue {
  ...
  int get rgbValue {
    return ((formatColorRgb.alpha * 255) << 24) |
        ((formatColorRgb.red * 255) << 16) |
        ((formatColorRgb.green * 255) << 8) |
        (formatColorRgb.blue * 255);
  }
}
...
class ColorConditionValueImpl implements ColorConditionValue {
  ...
  // Gets the rgbValue of the color
  int get rgbValue =>
      ((_formatColorRgb.alpha * 255) << 24) |
      ((_formatColorRgb.red * 255) << 16) |
      ((_formatColorRgb.green * 255) << 8) |
      (_formatColorRgb.blue * 255);
}
